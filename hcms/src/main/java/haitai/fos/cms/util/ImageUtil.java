...
public class ImageUtil {
	static FosLogger logger = new FosLogger(ImageUtil.class);
	/**
	 * 实现图像的等比缩放
	 * 
	 * @param source
	 ...
	 * 
	 */
	public static void saveSubImage(String src, String dest, int x, int y,
		...
		try {
			...
			if (x < 0 || y < 0 || width - x > image.getWidth()
					|| height - y > image.getHeight()) {
