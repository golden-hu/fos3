...
CREATE TABLE IF NOT EXISTS `C_CUSTOMER` (
  ...
  `CUST_ORG_NO` VARCHAR(32) NULL DEFAULT NULL,
  `CUST_TAX_NO` VARCHAR(32) NULL DEFAULT NULL,
  `CUST_REG_ADDRESS` VARCHAR(200) NULL DEFAULT NULL,
  `CUST_EX_CODE` VARCHAR(32) NULL DEFAULT NULL,
  `GROU_ID` int(11) default NULL,
  `USER_ID` int(11) default NULL,
  `CREATE_BY` int(11) default NULL,
  `CREATE_TIME` datetime default NULL,
