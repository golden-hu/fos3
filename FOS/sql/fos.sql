...
CREATE TABLE IF NOT EXISTS `C_CUSTOMER` (
  ...
  `CUST_CLASS` VARCHAR(16) collate utf8_unicode_ci default NULL,
  ...
  `CUST_ORG_NO` VARCHAR(32) default NULL,
  `CUST_TAX_NO` VARCHAR(32) default NULL,
  `CUST_REG_ADDRESS` VARCHAR(200) default NULL,
  `CUST_EX_CODE` VARCHAR(32) default NULL,
  `CUST_PROVINCE_ID` INT(11) default NULL,
  `CUST_CITY_ID` INT(11) default NULL,
  `CUST_OIL_FLAG` TINYINT(4) default NULL,
  `CUST_FACTORY_FLAG` TINYINT(4) default NULL,
  `MARINE_FLAG` TINYINT(4) default NULL,
  `AIR_FLAG` TINYINT(4) default NULL,
  `EXPRESS_FLAG` TINYINT(4) default NULL,
  `CUSTOMS_FLAG` TINYINT(4) default NULL,
  `WMS_FLAG` TINYINT(4) default NULL,
  `TMS_FLAG` TINYINT(4) default NULL,
...
CREATE TABLE `F_CONSIGN` (
	...
	`CONS_CONTRACT_NO` VARCHAR(500) NULL DEFAULT NULL COLLATE 'utf8_unicode_ci',
	...
	`CONS_BRANCH_ID` INT NULL DEFAULT NULL,
	`CONS_BRANCH_NAME` VARCHAR(50) NULL DEFAULT NULL,
	...
	`CONS_DO_AGENCY_ADDRESS` VARCHAR(64) NULL DEFAULT NULL,
	...
	`CONS_CARRIER_CONTACT` VARCHAR(64) NULL DEFAULT NULL,
	`CONS_CARRIER_TEL` VARCHAR(64) NULL DEFAULT NULL,
	...
	`CONS_CUSTOMS_TYPE` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `F_DOC` (
  ...
  `FDOC_RETURN_WAY` TINYINT NULL DEFAULT NULL,
  `FDOC_EXPRESS_NO` VARCHAR(32) NULL DEFAULT NULL,
  `FDOC_CUSTOMS_FLAG` TINYINT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `G_CARGO_TYPE` (
  ...
  `CATY_MANU_NO` VARCHAR(64) NULL DEFAULT NULL,
  `CATY_SPEC` VARCHAR(64) NULL DEFAULT NULL,
  `CATY_CARGO_TYPE` VARCHAR(64) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `G_PORT` (
  ...
  `PORT_NAME_EN` varchar(64) collate utf8_unicode_ci NOT NULL,
  ...
  `COUN_CODE` char(4) collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `P_BRANCH` (
	...
	`MODIFY_TIME` DATETIME NULL DEFAULT NULL,
	`COMP_CODE` CHAR(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `S_EXPENSE` (
  ...
  `EXPE_INVOICE_TITLE` VARCHAR(200)  default NULL,
...
CREATE TABLE IF NOT EXISTS `S_INVOICE` (
  ...
  `INVO_AMOUNT_PAID` decimal(12,2) default NULL,
  ...
  `INVO_CONTRACT_NO` varchar(128) collate utf8_unicode_ci default NULL,
  ...
  `VOUC_NO` varchar(500) collate utf8_unicode_ci default NULL,
...
CREATE TABLE IF NOT EXISTS `S_INVOICE_ITEM` (
  ...
  `INVO_TITLE` VARCHAR(200)  default NULL,
...
CREATE TABLE IF NOT EXISTS `S_PR` (
  ...
  `PR_FIN_APPROVE_BY` VARCHAR(32) default NULL,
  `PR_FIN_APPROVE_DATE` date default NULL,
  `PR_APPROVE_BY` VARCHAR(32) default NULL,
  `PR_APPROVE_DATE` date default NULL,
  `PR_STATUS` tinyint(4) default NULL,
  `PR_WRITE_OFF_STATUS` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `S_PR_ITEM` (
  ...
  `PR_AMOUNT_PAID` decimal(12,4)  default NULL,
  `INVO_BANK` varchar(64) collate utf8_unicode_ci default NULL,
