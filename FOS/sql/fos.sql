...
CREATE TABLE IF NOT EXISTS `P_ACTION` (
  ...
  `ACT_CLASS` varchar(50) collate utf8_unicode_ci NOT NULL,
...
INSERT INTO `P_ACTION` (`ACT_ID`, `ACT_NAME`, `ACT_CLASS`, `ACT_METHOD`, `ACT_SERVICE`, `ACT_REMARK`, `ACT_DAEMON_FLAG`, `ACT_SINGLETON_FLAG`) VALUES
(1, 'CUCA_S', 'SysController', 'saveCustomerCategory', '', '客户类型保存', 0, 0),
(2, 'CUCA_Q', 'SysController', 'queryCustomerCategory', '', '客户类型查询', 0, 0),
(3, 'VECA_S', 'SysController', 'saveVendorCategory', '', '供应商类型保存', 0, 0),
(4, 'VECA_Q', 'SysController', 'queryVendorCategory', '', '供应商类型查询', 0, 0),
(5, 'COUN_S', 'GeneralController', 'save', 'GCountryService', '国家保存', 0, 0),
(6, 'COUN_Q', 'GeneralController', 'query', 'GCountryService', '国家查询', 0, 0),
(7, 'UNIT_S', 'GeneralController', 'save', 'GUnitService', '单位保存', 0, 0),
(8, 'UNIT_Q', 'GeneralController', 'query', 'GUnitService', '单位查询', 0, 0),
(9, 'CUST_S', 'SysController', 'saveCustomer', '', '客户保存', 0, 0),
(10, 'CUST_Q', 'SysController', 'queryCustomer', '', '客户查询', 0, 0),
(11, 'VEND_S', 'GeneralController', 'save', 'CVendorService', '供应商保存', 0, 0),
(12, 'VEND_Q', 'GeneralController', 'query', 'CVendorService', '供应商查询', 0, 0),
(13, 'CHAR_S', 'GeneralController', 'save', 'GChargeService', '费用项目保存', 0, 0),
(14, 'CHAR_Q', 'GeneralController', 'query', 'GChargeService', '费用项目查询', 0, 0),
(15, 'CHCL_S', 'GeneralController', 'save', 'GChargeClassService', '费用类别保存', 0, 0),
(16, 'CHCL_Q', 'GeneralController', 'query', 'GChargeClassService', '费用类别查询', 0, 0),
(17, 'COTY_S', 'GeneralController', 'save', 'GContainerTypeService', '箱型保存', 0, 0),
(18, 'COTY_Q', 'GeneralController', 'query', 'GContainerTypeService', '箱型查询', 0, 0),
(19, 'CURR_S', 'GeneralController', 'save', 'GCurrencyService', '币别保存', 0, 0),
(20, 'CURR_Q', 'GeneralController', 'query', 'GCurrencyService', '币别查询', 0, 0),
(21, 'DOTY_S', 'GeneralController', 'save', 'GDocumentTypeService', '文档类型保存', 0, 0),
(22, 'DOTY_Q', 'GeneralController', 'query', 'GDocumentTypeService', '文档类型查询', 0, 0),
(23, 'EXSE_S', 'GeneralController', 'save', 'GExchangeSettlementService', '结汇方式保存', 0, 0),
(24, 'EXSE_Q', 'GeneralController', 'query', 'GExchangeSettlementService', '结汇方式查询', 0, 0),
(25, 'ISTY_S', 'GeneralController', 'save', 'GIssueTypeService', '签单方式保存', 0, 0),
(26, 'ISTY_Q', 'GeneralController', 'query', 'GIssueTypeService', '签单方式查询', 0, 0),
(27, 'LETY_S', 'GeneralController', 'save', 'GLevyTypeService', '征免方式保存', 0, 0),
(28, 'LETY_Q', 'GeneralController', 'query', 'GLevyTypeService', '征免方式查询', 0, 0),
(29, 'LIPO_S', 'GeneralController', 'save', 'GLinePortService', '港口保存', 0, 0),
(30, 'LIPO_Q', 'GeneralController', 'query', 'GLinePortService', '港口查询', 0, 0),
(31, 'PORT_S', 'GeneralController', 'save', 'GPortService', '港口保存', 0, 0),
(32, 'PORT_Q', 'GeneralController', 'query', 'GPortService', '港口查询', 0, 0),
(33, 'PACK_S', 'GeneralController', 'save', 'GPackageService', '包装种类保存', 0, 0),
(34, 'PACK_Q', 'GeneralController', 'query', 'GPackageService', '包装种类查询', 0, 0),
(35, 'PATE_S', 'GeneralController', 'save', 'GPaymentTermService', '支付条款保存', 0, 0),
(36, 'PATE_Q', 'GeneralController', 'query', 'GPaymentTermService', '支付条款查询', 0, 0),
(37, 'SEWA_S', 'GeneralController', 'save', 'GSettlementWayService', '结算方式保存', 0, 0),
(38, 'SEWA_Q', 'GeneralController', 'query', 'GSettlementWayService', '结算方式查询', 0, 0),
(39, 'SHLI_S', 'GeneralController', 'save', 'GShippingLineService', '航线保存', 0, 0),
(40, 'SHLI_Q', 'GeneralController', 'query', 'GShippingLineService', '航线查询', 0, 0),
(41, 'TRTE_S', 'GeneralController', 'save', 'GTradeTermService', '贸易条款保存', 0, 0),
(42, 'TRTE_Q', 'GeneralController', 'query', 'GTradeTermService', '贸易条款查询', 0, 0),
(43, 'TRTY_S', 'GeneralController', 'save', 'GTradeTypeService', '贸易类型保存', 0, 0),
(44, 'TRTY_Q', 'GeneralController', 'query', 'GTradeTypeService', '贸易类型查询', 0, 0),
(45, 'TTER_S', 'GeneralController', 'save', 'GTransTermService', '运输条款保存', 0, 0),
(46, 'TTER_Q', 'GeneralController', 'query', 'GTransTermService', '运输条款查询', 0, 0),
(47, 'TRAT_S', 'GeneralController', 'save', 'GTransTypeService', '运输类型保存', 0, 0),
(48, 'TRAT_Q', 'GeneralController', 'query', 'GTransTypeService', '运输类型查询', 0, 0),
(49, 'USAG_S', 'GeneralController', 'save', 'GUsageService', '用途保存', 0, 0),
(50, 'USAG_Q', 'GeneralController', 'query', 'GUsageService', '用途查询', 0, 0),
(51, 'VESS_S', 'GeneralController', 'save', 'GVesselService', '船名保存', 0, 0),
(52, 'VESS_Q', 'GeneralController', 'query', 'GVesselService', '船名查询', 0, 0),
(53, 'VOYA_S', 'GeneralController', 'save', 'GVoyageService', '航次保存', 0, 0),
(54, 'VOYA_Q', 'GeneralController', 'query', 'GVoyageService', '航次查询', 0, 0),
(55, 'COCL_S', 'GeneralController', 'save', 'GContainerClassService', '箱类保存', 0, 0),
(56, 'COCL_Q', 'GeneralController', 'query', 'GContainerClassService', '箱类查询', 0, 0),
(57, 'VESS_VOYA_S', 'GeneralController', 'getVoyageByVessel', '', '船名查询航次', 0, 0),
(58, 'COUN_PORT_S', 'GeneralController', 'getPortByCountry', '', '国家查询港口', 0, 0),
(59, 'CONS_S', 'FfopController', 'save', '', '委托保存', 0, 0),
(60, 'CONS_Q', 'FfopController', 'query', '', '委托查询', 0, 0),
(61, 'CONS_U', 'FfopController', 'updateConsignStatusById', '', '委托状态修改', 0, 0),
(62, 'BOOK_U', 'FfopController', 'updateConsignStatusBookById', '', '定舱状态修改', 0, 0),
(63, 'CONT_S', 'FfopController', 'saveContainer', '', '箱保存', 0, 0),
(64, 'CONT_Q', 'FfopController', 'queryContainer', '', '箱查询', 0, 0),
(65, 'BL_S', 'FfopController', 'saveBl', '', '提单保存', 0, 0),
(66, 'BL_Q', 'FfopController', 'queryBl', '', '提单查询', 0, 0),
(67, 'BL_U', 'FfopController', 'updateBlStatusById', '', '提单状态修改', 0, 0),
(68, 'TRAN_S', 'FfopController', 'saveTrans', '', '运输保存', 0, 0),
(69, 'TRAN_Q', 'FfopController', 'queryTrans', '', '运输查询', 0, 0),
(70, 'TRTA_Q', 'FfopController', 'queryTransTask', '', '运输任务查询', 0, 0),
(71, 'WARE_S', 'FfopController', 'saveWarehouse', '', '仓储保存', 0, 0),
(72, 'WARE_Q', 'FfopController', 'queryWarehouse', '', '仓储查询', 0, 0),
(73, 'WACA_Q', 'FfopController', 'queryWarehouseCargo', '', '仓储货物查询', 0, 0),
(74, 'INSP_S', 'FfopController', 'saveInspection', '', '报检保存', 0, 0),
(75, 'INSP_Q', 'FfopController', 'queryInspection', '', '报检查询', 0, 0),
(76, 'INDO_Q', 'FfopController', 'queryInspectionDoc', '', '报检单据查询', 0, 0),
(77, 'CUDE_S', 'FfopController', 'saveCustomsDeclaration', '', '报关单保存', 0, 0),
(78, 'CUDE_Q', 'FfopController', 'queryCustomsDeclaration', '', '报关单查询', 0, 0),
(79, 'CUDO_Q', 'FfopController', 'queryCustomsDoc', '', '报关单据查询', 0, 0),
(80, 'CUEN_Q', 'FfopController', 'queryCustomsEntry', '', '报关货物查询', 0, 0),
(81, 'CARG_S', 'FfopController', 'saveCargo', '', '货物保存', 0, 0),
(82, 'CARG_Q', 'FfopController', 'queryCargo', '', '货物查询', 0, 0),
(83, 'DO_Q', 'FfopController', 'queryDo', '', '提货单查询', 0, 0),
(84, 'EXPE_S', 'FfseController', 'saveExpense', '', '费用保存', 0, 0),
(85, 'EXPE_Q', 'FfseController', 'queryExpense', '', '费用查询', 0, 0),
(86, 'INVO_S', 'FfseController', 'saveInvoice', '', '发票保存', 0, 0),
(87, 'INVO_Q', 'FfseController', 'queryInvoice', '', '发票查询', 0, 0),
(88, 'COCO_S', 'SysController', 'saveCompanyConfig', '', '公司配置保存', 0, 0),
(89, 'COCO_Q', 'SysController', 'queryCompanyConfig', '', '公司配置查询', 0, 0),
(90, 'COBA_S', 'SysController', 'saveCompanyBankAccount', '', '公司银行账号保存', 0, 0),
(91, 'COBA_Q', 'SysController', 'queryCompanyBankAccount', '', '公司银行账号查询', 0, 0),
(92, 'EXPE_INV_Q', 'FfseController', 'invoiceCreateQuery', '', '费用生成发票查询', 0, 0),
(93, 'CONS_CHECK_Q', 'FfopController', 'complexQueryCheck', '', '委托审核查询', 0, 0),
(94, 'EXRA_S', 'FfseController', 'saveExRate', '', '汇率保存', 0, 0),
(95, 'EXRA_Q', 'FfseController', 'queryExRate', '', '汇率查询', 0, 0),
(96, 'EXPE_WROF_Q', 'FfseController', 'writeOffQuery', '', '费用已开票未核销查询', 0, 0),
(97, 'INIT_Q', 'FfseController', 'queryInvoiceItem', '', '发票费用明细查询', 0, 0),
(98, 'INEN_Q', 'FfseController', 'queryInvoiceEntry', '', '发票打印明细查询', 0, 0),
(99, 'INVO_U', 'FfseController', 'checkInvoice', '', '发票审核', 0, 0),
(100, 'INVO_C', 'FfseController', 'cancelInvoice', '', '作废发票', 0, 0),
(101, 'VOUC_S', 'FfseController', 'saveVoucher', '', '收款单保存', 0, 0),
(102, 'VOUC_Q', 'FfseController', 'queryVoucher', '', '收款单查询', 0, 0),
(103, 'PR_S', 'FfseController', 'savePr', '', '托收单/付款申请保存', 0, 0),
(104, 'PR_Q', 'FfseController', 'queryPr', '', '托收单/付款申请查询', 0, 0),
(105, 'PRIT_Q', 'FfseController', 'queryPrItem', '', '托收单/付款申请明细查询', 0, 0),
(106, 'PR_U', 'FfseController', 'updatePrStatus', '', '托收单/付款申请状态修改', 0, 0),
(107, 'USER_S', 'SysController', 'saveUser', '', '用户保存', 0, 0),
(108, 'USER_Q', 'SysController', 'queryUser', '', '用户查询', 0, 0),
(109, 'GROU_S', 'SysController', 'saveGroup', '', '组保存', 0, 0),
(110, 'GROU_Q', 'SysController', 'queryGroup', '', '组查询', 0, 0),
(111, 'ROLE_S', 'SysController', 'saveRole', '', '角色保存', 0, 0),
(112, 'ROLE_Q', 'SysController', 'queryRole', '', '角色查询', 0, 0),
(113, 'CUDE_U', 'FfopController', 'updateCustomsDeclarationStatus', '', '报关单状态更新', 0, 0),
(114, 'GRUS_Q', 'SysController', 'queryGroupUser', '', '组用户查询', 0, 0),
(115, 'USRO_Q', 'SysController', 'queryUserRole', '', '用户角色查询', 0, 0),
(116, 'USER_U', 'SysController', 'updateUserPassword', '', '用户密码修改', 0, 0),
(117, 'FUNC_S', 'SysController', 'saveFunction', '', '功能点保存', 0, 0),
(118, 'FUNC_Q', 'SysController', 'queryFunction', '', '功能点查询', 0, 0),
(119, 'ROFU_S', 'SysController', 'saveRoleFunction', '', '角色功能点保存', 0, 0),
(120, 'ROFU_Q', 'SysController', 'queryRoleFunction', '', '角色功能点查询', 0, 0),
(121, 'CONS_X', 'FfopController', 'complexQueryConsign', '', '委托综合查询', 0, 0),
(122, 'INVO_X', 'FfseController', 'complexQueryInvoice', '', '发票综合查询', 0, 0),
(123, 'CONS_CONTNO_X', 'FfopController', 'complexQueryConsignByContNo', '', '箱号查询委托', 0, 0),
(124, 'CONS_CHECK_X', 'FfopController', 'complexQueryCheck', '', '委托审核综合查询', 0, 0),
(125, 'PR_X', 'FfseController', 'complexQueryPr', '', '托收单/付款申请综合查询', 0, 0),
(126, 'VOUC_X', 'FfseController', 'complexQueryVoucher', '', '收款单综合查询', 0, 0),
(127, 'TETY_S', 'SysController', 'saveTemplateType', '', '打印模板类型保存', 0, 0),
(128, 'TETY_Q', 'SysController', 'queryTemplateType', '', '打印模板类型查询', 0, 0),
(129, 'TEMP_S', 'SysController', 'saveTemplate', '', '打印模板保存', 0, 0),
(130, 'TEMP_Q', 'SysController', 'queryTemplate', '', '打印模板查询', 0, 0),
(131, 'TEMP_D', 'SysController', 'downTemplate', '', '下载打印模板', 0, 0),
(132, 'TEMP_U', 'SysController', 'uploadTemplate', '', '上传打印模板', 0, 0),
(133, 'TEMA_S', 'SysController', 'saveTemplateMap', '', '打印模板映射保存', 0, 0),
(134, 'TEMA_Q', 'SysController', 'queryTemplateMap', '', '打印模板映射查询', 0, 0),
(135, 'TEMP_E', 'SysController', 'exportTemplate', '', '导出打印模板', 0, 0),
(136, 'MESS_S', 'SysController', 'saveMessage', '', '消息保存', 0, 0),
(137, 'MESS_Q', 'SysController', 'queryMessage', '', '消息查询', 0, 0),
(138, 'COCA_S', 'FfopController', 'saveContainerCargo', '', '箱货物保存', 0, 0),
(139, 'COCA_Q', 'FfopController', 'queryContainerCargo', '', '箱货物查询', 0, 0),
(140, 'TRCA_Q', 'FfopController', 'queryTransCargo', '', '箱货物查询', 0, 0),
(141, 'CACL_S', 'GeneralController', 'save', 'GCargoClassService', '货物分类保存', 0, 0),
(142, 'CACL_Q', 'GeneralController', 'query', 'GCargoClassService', '货物分类查询', 0, 0),
(143, 'CATY_S', 'GeneralController', 'save', 'GCargoTypeService', '货物类型保存', 0, 0),
(144, 'CATY_Q', 'GeneralController', 'query', 'GCargoTypeService', '货物类型查询', 0, 0),
(145, 'VEHT_S', 'GeneralController', 'save', 'GVehicleTypeService', '车辆类型保存', 0, 0),
(146, 'VEHT_Q', 'GeneralController', 'query', 'GVehicleTypeService', '车辆类型查询', 0, 0),
(147, 'SESH_S', 'FfopController', 'saveSecondShip', '', '二程船保存', 0, 0),
(148, 'SESH_Q', 'FfopController', 'querySecondShip', '', '二程船查询', 0, 0),
(149, 'RABL_S', 'FfopController', 'saveRailwayBl', '', '铁路运单保存', 0, 0),
(150, 'RABL_Q', 'FfopController', 'queryRailwayBl', '', '铁路运单查询', 0, 0),
(151, 'DO_U', 'FfopController', 'updateDoStatus', '', '提货单修改', 0, 0),
(152, 'INDO_U', 'FfopController', 'updateInspectionDocStatus', '', '报检单据修改', 0, 0),
(153, 'CUDO_U', 'FfopController', 'updateCustomsDocStatus', '', '报关单据修改', 0, 0),
(154, 'CONS_MNO_U', 'FfopController', 'updateConsMasterNo', '', '主单号修改', 0, 0),
(155, 'PRSH_S', 'SysController', 'savePriceSheet', '', '价格单保存', 0, 0),
(156, 'PRSH_Q', 'SysController', 'queryPriceSheet', '', '价格单查询', 0, 0),
(157, 'PRLI_Q', 'SysController', 'queryPriceLine', '', '价格单行查询', 0, 0),
(158, 'PRRE_Q', 'SysController', 'queryPriceRecord', '', '价格单行的记录查询', 0, 0),
(159, 'CARG_MID_Q', 'FfopController', 'queryCargoByConsMasterId', '', '根据并单主单号查询货物列表', 0, 0),
(160, 'REPT_BUCA', '', '', 'fconsign.rptdesign', '业务分类汇总统计表(按业务性质)', 0, 0),
(161, 'REPT_BUDE', '', '', 'business_detail.rptdesign', '业务明细统计表', 0, 0),
(162, 'REPT_ACAR', '', '', 'account_age_r.rptdesign', '应收账款账龄分析表', 0, 0),
(163, 'REPT_ACAP', '', '', 'account_age_p.rptdesign', '应付账款账龄分析表', 0, 0),
(164, 'REPT_CUEX', '', '', 'cust_expense.rptdesign', '客户应收费用统计', 0, 0),
(165, 'REPT_VEEX', '', '', 'vendor_expense.rptdesign', '供应商应付费用统计', 0, 0),
(166, 'REPT_BUCO', '', '', 'fconsign_other.rptdesign', '业务分类汇总统计表(其他统计类型)', 0, 0),
(167, 'INSP_U', 'FfopController', 'updateInspectionStatus', '', '报检修改', 0, 0),
(168, 'RABL_U', 'FfopController', 'updateRailwayBlStatus', '', '铁路运单修改', 0, 0),
(169, 'TRAN_U', 'FfopController', 'updateTransStatus', '', '运输修改', 0, 0),
(170, 'VOUC_U', 'FfseController', 'updateVoucherStatus', '', '收款单状态修改', 0, 0),
(171, 'CUCO_Q', 'SysController', 'queryCustomerContact', '', '客户联系人查询', 0, 0),
(172, 'BILL_S', 'FfseController', 'saveBill', '', '对帐单保存', 0, 0),
(173, 'BILL_Q', 'FfseController', 'queryBill', '', '对帐单查询', 0, 0),
(174, 'BIIT_Q', 'FfseController', 'queryBillItem', '', '对帐单明细查询', 0, 0),
(175, 'LOGIN', 'SysController', 'login', '', '登录', 0, 0),
(176, 'USER_MY_Q', 'SysController', 'queryCurrentUser', '', '获取当前用户信息', 0, 0),
(177, 'LOGOUT', 'SysController', 'logout', '', '退出登录', 0, 0),
(178, 'EXPE_X', 'FfseController', 'complexQueryExpense', '', '费用综合查询', 0, 0),
(179, 'BL_X', 'FfopController', 'complexQueryBl', '', '提单综合查询', 0, 0),
(180, 'CUDE_X', 'FfopController', 'complexQueryCustomsDeclaration', '', '报关综合查询', 0, 0),
(181, 'PRSH_X', 'SysController', 'complexQueryPriceSheet', '', '价格单复杂查询', 0, 0),
(182, 'CUST_X', 'SysController', 'complexQueryCustomer', '', '客户复杂查询', 0, 0),
(183, 'VESS_X', 'GeneralController', 'complexQueryVessel', '', '船名复杂查询', 0, 0),
(184, 'FDOC_S', 'FfopController', 'saveDoc', '', '单证保存', 0, 0),
(185, 'FDOC_Q', 'FfopController', 'queryDoc', '', '单证查询', 0, 0),
(186, 'FDOC_U', 'FfopController', 'updateDocStatus', '', '单证状态修改', 0, 0),
(187, 'FDOC_X', 'FfopController', 'complexQueryDoc', '', '单据复杂查询', 0, 0),
(188, 'INNO_S', 'FfseController', 'saveInvoiceNo', '', '税务发票编号保存', 0, 0),
(189, 'INNO_Q', 'FfseController', 'queryInvoiceNo', NULL, '税务发票编号查询', 0, 0),
(190, 'VOYA_U', 'FfopController', 'updateSailDate', NULL, '更新开船日期和开船状态', 0, 0),
(191, 'CONT_X', 'FfopController', 'complexQueryContainerByVoyageId', '', '根据航次id查询箱', 0, 0),
(192, 'INNO_U', 'FfseController', 'updateInvoiceNoActiveFlag', NULL, '税务发票编号启用', 0, 0),
(193, 'REAS_S', 'FfopController', 'saveReassign', '', '改配漏装保存', 0, 0),
(194, 'REAS_Q', 'FfopController', 'queryReassign', NULL, '改配漏装查询', 0, 0),
(195, 'BILL_X', 'FfseController', 'complexQueryBill', '', '对帐单复杂查询', 0, 0),
(196, 'REPT_PROF', '', '', 'profit_detail.rptdesign', '利润明细分析表', 0, 0),
(197, 'PORT_X', 'GeneralController', 'complexQueryPort', '', '港口复杂查询', 0, 0),
(198, 'VOIT_Q', 'FfseController', 'queryVoucherItem', NULL, '核销单明细查询', 0, 0),
(199, 'VOUC_C', 'FfseController', 'cancelVoucher', '', '作废核销单', 0, 0),
(200, 'INIT_PR_X', 'FfseController', 'complexQueryInvoiceItemByPrId', '', '根据付款申请id查询发票费用明细', 0, 0),
(201, 'UNIT_C', 'GeneralController', 'queryUnitPlusContType', '', '单位加箱型查询', 0, 0),
(202, 'PRSH_U', 'SysController', 'updatePriceSheetStatus', NULL, '更新价格单状态', 0, 0),
(203, 'REPT_BUSI', '', '', 'business.rptdesign', '业务汇总统计表', 0, 0),
(204, 'REPT_BUEX', '', '', 'profit.rptdesign', '利润汇总统计表', 0, 0),
(205, 'SAQU_S', 'SysController', 'saveSalesQuota', '', '业务员提成保存', 0, 0),
(206, 'SAQU_Q', 'SysController', 'querySalesQuota', '', '业务员提成查询', 0, 0),
(207, 'REPT_SALES', '', '', 'sales_commission.rptdesign', '业务员提成统计', 0, 0),
(208, 'REPT_WROF', '', '', 'write_off.rptdesign', '核销统计表', 0, 0),
(209, 'REPT_ARA', '', '', 'expense_month_r.rptdesign', '应收账款回收情况统计表', 0, 0),
(210, 'REPT_PAY_PLAN', '', '', 'payment_plan.rptdesign', '付款计划', 0, 0),
(211, 'REPT_PRCH', '', '', 'profit_charge.rptdesign', '费用单票占利润比例统计', 0, 0),
(212, 'FCON_S', 'FfopController', 'saveContract', '', '合同保存', 0, 0),
(213, 'FCON_Q', 'FfopController', 'queryContract', '', '合同查询', 0, 0),
(214, 'LOLI_S', 'FfopController', 'saveLoadingList', '', '货物配船保存', 0, 0),
(215, 'LOLI_Q', 'FfopController', 'queryLoadingList', '', '货物配船查询', 0, 0),
(216, 'FCON_X', 'FfopController', 'complexQueryContract', '', '合同复杂查询', 0, 0),
(217, 'VOYA_LOLI_Q', 'FfopController', 'queryVoyageAndLoadingList', '', '航次和货物配船查询', 0, 0),
(218, 'PLAC_S', 'GeneralController', 'save', 'GPlaceService', '港区保存', 0, 0),
(219, 'PLAC_Q', 'GeneralController', 'query', 'GPlaceService', '港区查询', 0, 0),
(220, 'VOYA_X', 'GeneralController', 'complexQuery', 'GVoyageService', '船期复杂查询', 0, 0),
(221, 'INRA_S', 'FfseController', 'saveInterestRate', '', '利息保存', 0, 0),
(222, 'INRA_Q', 'FfseController', 'queryInterestRate', '', '利息查询', 0, 0),
(223, 'INIT_X', 'FfseController', 'complexQueryInvoiceItem', '', '发票费用明细复杂查询', 0, 0),
(224, 'REPT_PROF_SALES', '', '', 'profit_detail_sales.rptdesign', '业务员利润明细分析表', 0, 0),
(225, 'PALI_S', 'FfopController', 'savePackingList', '', '发货清单保存', 0, 0),
(226, 'PALI_Q', 'FfopController', 'queryPackingList', '', '发货清单查询', 0, 0),
(227, 'TRLI_S', 'FfopController', 'saveTransList', '', '发货转运清单保存', 0, 0),
(228, 'TRLI_Q', 'FfopController', 'queryTransList', '', '发货转运清单查询', 0, 0),
(229, 'BUEX_S', 'FfseController', 'saveBulkExpense', '', '调度费用保存', 0, 0),
(230, 'BUEX_Q', 'FfseController', 'queryBulkExpense', '', '调度费用查询', 0, 0),
(231, 'TASK_S', 'FfopController', 'saveTask', '', '任务保存', 0, 0),
(232, 'TASK_Q', 'FfopController', 'queryTask', '', '任务查询', 0, 0),
(233, 'TATY_S', 'SysController', 'saveTaskType', '', '任务类型保存', 0, 0),
(234, 'TATY_Q', 'SysController', 'queryTaskType', '', '任务类型查询', 0, 0),
(235, 'EXPB_X', 'FfseController', 'complexQueryExpenseB', '', '费用修改历史综合查询', 0, 0),
(236, 'REPT_PRCO', '', '', 'profit_commission.rptdesign', '代理费占利润比例统计', 0, 0),
(237, 'PALI_X', 'FfopController', 'complexQueryPackingList', '', '发货清单复杂查询', 0, 0),
(238, 'TEMP_I', 'SysController', 'importTemplate', '', '模板导入数据', 0, 0),
(239, 'REPT_PALI', '', '', 'packing_list.rptdesign', '出货港发货通知书', 0, 0),
(240, 'CHAR_X', 'GeneralController', 'complexQuery', 'GChargeService', '费用项目复杂查询', 0, 0),
(241, 'ACLO_X', 'SysController', 'complexQueryActionLog', '', '操作日志复杂查询', 0, 0),
(242, 'CUST_M', 'SysController', 'mergeCustomer', '', '客户供应商归并', 0, 0),
(243, 'CHAR_C', 'GeneralController', 'queryChargeCommission', '', '代理费费用项目查询', 0, 0),
(244, 'REPT_VOCU', '', '', 'voyage_cust.rptdesign', '船期表', 0, 0),
(245, 'REPT_PACU', '', '', 'packing_cust.rptdesign', '发货汇总清单-规格', 0, 0),
(246, 'USER_L', 'SysController', 'listOnlineUsers', '', '在线用户查询', 0, 0),
(247, 'USER_K', 'SysController', 'killOnlineUser', '', '在线用户清理', 0, 0),
(248, 'BALA_Q', 'FfseController', 'queryBalance', '', '客户余额查询', 0, 0),
(249, 'REPT_EXCO', '', '', 'packing_fee_confirm.rptdesign', '码头费用确认书', 0, 0),
(250, 'REPT_PAHY', '', '', 'packing_hy.rptdesign', '发货汇总清单-发货方式', 0, 0),
(251, 'HCRE_S', 'CmsController', 'saveResource', '', '资源保存', 0, 0),
(252, 'HCRE_Q', 'CmsController', 'queryResource', '', '资源查询', 0, 0),
(253, 'MESU_S', 'SysController', 'saveMessageSubscribe', '', '消息订阅保存', 0, 0),
(254, 'MESU_Q', 'SysController', 'queryMessageSubscribe', '', '消息订阅查询', 0, 0),
(255, 'METO_S', 'SysController', 'saveMessageTopic', '', '消息主题保存', 0, 0),
(256, 'METO_Q', 'SysController', 'queryMessageTopic', '', '消息主题查询', 0, 0),
(257, 'EXHI_S', 'ExpController', 'saveExportHistory', '', '导出历史保存', 0, 0),
(258, 'EXHI_Q', 'ExpController', 'queryExportHistory', '', '导出历史查询', 0, 0),
(259, 'EXHI_E', 'ExpController', 'dumpExportHistory', '', '导出财务数据', 0, 0),
(260, 'FILE_U', 'CmsController', 'uploadFile', '', '文件上传', 0, 0),
(261, 'USSE_S', 'SysController', 'saveUserSetting', '', '用户设置保存', 0, 0),
(262, 'USSE_G', 'SysController', 'queryUserSetting', '', '用户设置查询', 0, 0),
(263, 'CHAN_S', 'CmsController', 'saveChannel', '', '频道保存', 0, 0),
(264, 'CHAN_Q', 'CmsController', 'queryChannel', '', '频道查询', 0, 0),
(265, 'SITE_S', 'CmsController', 'saveSite', '', '站点保存', 0, 0),
(266, 'SITE_Q', 'CmsController', 'querySite', '', '站点查询', 0, 0),
(267, 'HCTE_S', 'CmsController', 'saveTemplate', '', '模板保存', 0, 0),
(268, 'HCTE_Q', 'CmsController', 'queryTemplate', '', '模板查询', 0, 0),
(269, 'REPT_PACBM', '', '', 'packing_cbm.rptdesign', '发货汇总清单-规格(体积)', 0, 0),
(270, 'REPT_PAPI', '', '', 'packing_pieces.rptdesign', '发货汇总清单-规格(支数)', 0, 0),
(271, 'REPT_PASL', '', '', 'packing_seamless.rptdesign', '发货汇总清单-西姆莱斯', 0, 0),
(272, 'MESS_X', 'SysController', 'queryMessageOwn', '', '消息历史查询', 0, 0),
(273, 'REPT_PAIV', '', '', 'packing_inventory.rptdesign', '盘存表', 0, 0),
(274, 'REPT_SEEX', '', '', 'settlement_expense.rptdesign', '客户应收费用统计', 0, 0),
(275, 'REPT_PAOD', '', '', 'packing_overdue.rptdesign', '超期表', 0, 0),
(276, 'REPT_PAPL', '', '', 'packing_pieces_length.rptdesign', '发货汇总清单-规格(支数总长度)', 0, 0),
(277, 'HCAR_PV', 'CmsController', 'previewArticle', '', '文章预览', 0, 0),
(278, 'HCAR_PB', 'CmsController', 'publish', '', '文章发布', 0, 0),
(279, 'CHAN_PV', 'CmsController', 'previewChannel', '', '频道预览', 0, 0),
(280, 'CHAN_PB', 'CmsController', 'publish', '', '频道发布', 0, 0),
(281, 'CONS_CARGO_Q', 'FfopController', 'queryConsignByCargoId', '', '根据货物id查询委托', 0, 0),
(282, 'CONS_BL_Q', 'FfopController', 'queryConsignByBlId', '', '根据提单id查询委托', 0, 0),
(283, 'USEP_S', 'SysController', 'saveUserExpePermission', '', '用户费用权限保存', 0, 0),
(284, 'USEP_Q', 'SysController', 'queryUserExpePermission', '', '用户费用权限查询', 0, 0),
(285, 'USEP_ALL_Q', 'SysController', 'queryUsepIncludeNotExist', '', '用户费用权限查询(所有)', 0, 0),
(286, 'EXPE_PERM_Q', 'FfseController', 'queryExpenseFilted', '', '费用查询(根据费用权限过滤)', 0, 0),
(287, 'CHAR_PERM_Q', 'GeneralController', 'queryChargeFilted', 'GChargeService', '费用项目查询(根据用户费用权限过滤)', 0, 0),
(288, 'BL_M', 'FfopController', 'mergeBl', '', '提单并单', 0, 0),
(289, 'COMM_Q', 'SysController', 'queryCommission', '', '业务员提成方案查询', 0, 0),
(290, 'COMM_S', 'SysController', 'saveCommission', '', '业务员提成方案保存', 0, 0),
(291, 'SACO_Q', 'SysController', 'querySalesCommission', '', '业务员提成方案设置查询', 0, 0),
(292, 'SACO_S', 'SysController', 'saveSalesCommission', '', '业务员提成方案设置保存', 0, 0),
(293, 'COIT_Q', 'SysController', 'queryCommissionItem', '', '业务员提成方案明细查询', 0, 0),
(294, 'COIT_S', 'SysController', 'saveCommissionItem', '', '业务员提成方案明细保存', 0, 0),
(295, 'SACO_R', 'SysController', 'calculateSalesCommission', '', '业务员提成统计', 0, 0),
(296, 'SACO_D_R', 'SysController', 'querySalesCommissionDetail', '', '业务员提成明细查询', 0, 0),
(297, 'REPT_PTEU', '', '', 'profit_teu.rptdesign', '集装箱单箱利润统计表', 0, 0),
(298, 'REPT_PAON', '', '', 'packing_overdue_now.rptdesign', '即时超期表', 0, 0),
(299, 'PLAC_E', 'FfopController', 'complexQueryPlaceByContract', '', '根据合同导出地点列表', 0, 0),
(300, 'FCON_V', 'FfopController', 'complexQueryContractByVoyaId', '', '根据航次id查询合同', 0, 0),
(301, 'REPT_PARE', '', '', 'packing_recent.rptdesign', '最近预计上船明细表', 0, 0),
(302, 'REPT_BUSI_SALES', '', '', 'business_sales.rptdesign', '业务员业务量汇总表', 0, 0),
