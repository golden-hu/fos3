...
CREATE TABLE IF NOT EXISTS `G_CARGO_TYPE` (
  ...
  `CATY_MANU_NO` VARCHAR(64) NULL DEFAULT NULL AFTER `CATY_NAME_EN`,
  `CATY_SPEC` VARCHAR(64) NULL DEFAULT NULL AFTER `CATY_MANU_No`,
  `CATY_CARGO_TYPE` VARCHAR(64) NULL DEFAULT NULL AFTER `CATY_SPEC`,
