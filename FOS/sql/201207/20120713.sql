...
ALTER TABLE `F_CUSTOMS_ENTRY`
	CHANGE COLUMN `CUEN_UNIT_PRICE` `CUEN_UNIT_PRICE` DECIMAL(9,4) NULL DEFAULT NULL AFTER `CUEN_COUNTRY`,
	CHANGE COLUMN `CUEN_TOTAL_PRICE` `CUEN_TOTAL_PRICE` DECIMAL(12,4) NULL DEFAULT NULL AFTER `CUEN_UNIT_PRICE`;
