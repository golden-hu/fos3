...
ALTER TABLE `F_CUSTOMS_DECLARATION`
	ADD COLUMN `CUDE_SHIP_DATE_T` DATETIME NULL DEFAULT NULL AFTER `CUDE_SHIP_DATE_F`;
ALTER TABLE `F_CUSTOMS_DECLARATION`
	ADD COLUMN `CUDE_TRANS_FLAG` TINYINT(4) NULL DEFAULT '0' AFTER `CUDE_DOC_RECEIVER`;
ALTER TABLE `F_CUSTOMS_DECLARATION`
	ADD COLUMN `CUDE_PARTIAL_FLAG` TINYINT(4) NULL DEFAULT '0' AFTER `CUDE_TRANS_FLAG`;
ALTER TABLE `F_CUSTOMS_DECLARATION`
