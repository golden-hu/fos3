...
Fos.SplitTab = function(p) {
	...
	items: [{layout:'column',layoutConfig: {columns:4},deferredRender:false,title:C_DO_APPLICATION_INFO,labelWidth:100,collapsible:true,
            items:[{columnWidth:.25,layout: 'form',border:false,
				...
				{fieldLabel:C_OVERSEA_CONSIGNEE,tabIndex:9,name:'consSplitConsignee',value:p.get('consSplitConsignee'),xtype:'textfield',anchor:'95%'}]},
                ...
                {fieldLabel:C_APPLY_COMPANY,tabIndex:11,name:'consSplitContact',value:p.get('consSplitContact'),xtype:'textfield',anchor:'95%'}]},
				{columnWidth:.25,layout: 'form',border : false,
