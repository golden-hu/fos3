...
Fos.TradeTab = function(p,store) {
    ...
    this.updateToolBar = function(){
    	...
    	if(tb.getComponent('TB_R')) tb.getComponent('TB_R').setDisabled(NR(m+F_R)||locked||disable||s!=0);
	...
	Fos.TradeTab.superclass.constructor.call(this, { 
		...
		tbar:[
		      ...
		      {text:C_REMOVE,itemId:'TB_R',iconCls:'remove',disabled:NR(m+F_R)||locked||disable||p.get('consStatus')!=0,scope:this,handler:this.del},'-',
