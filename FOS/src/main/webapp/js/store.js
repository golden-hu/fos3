FConsign = Ext.data.Record.create(['id','wconId',
	...
	'consSalesRepId','consSalesRepName','consOperatorId','consOperatorName','consTradeContractNo','consCreditNo','consInsuranceFee','custId',
	...
	'consInspectionVendor','consInspectionVendorName','consTrackVendor','consTrackVendorName','consTrackContact',
	{name:'consTrackLoadDate',type:'date',dateFormat:DATEF},
	'consTrackLoadAddress','consTrackRemarks','consTrackTel','consDoAgency','consDoAgencyName',
	'consBookingAgency','consBookingAgencyName','consBookingAgencySname',{name:'consBookingDate',type:'date',dateFormat:DATEF},'consBookingContractNo',
	...
	'consCustPackages','consCustGrossWeight','consCustMeasurement','consCustChargeWeight','unitId','unitCode','unitIdM','unitCodeM',
	...
	'consBPol','consBPolEn','consBPod','consBPodEn','consBPot','consBPotEn','consBShipper','consBConsignee','consBCountryD','consBCountryT',
	...
	'sumRCnyInvoice','sumRCnyWriteOff','sumPUsd','sumPUsdInvoice','sumPUsdWriteOff','sumPCny','sumPCnyInvoice','sumPCnyWriteOff','editable'
	]);
...
FTrans = Ext.data.Record.create(['id',
	'tranId','tranNo','consId','consNo','tranContractNo','tranVendorId','tranVendorName','tranVendorContact','tranVendorTel','tranVendorFax',
	{name:'tranDate',type:'date',dateFormat:DATEF},
	{name:'tranExpiryDate',type:'date',dateFormat:DATEF},
	{name:'tranLoadDate',type:'date',dateFormat:DATEF},
	{name:'tranStartDate',type:'date',dateFormat:DATEF},
	{name:'tranCompleteDate',type:'date',dateFormat:DATEF},
	{name:'tranEtd',type:'date',dateFormat:DATEF},
	...
	'tranDeliveryAddress','tranCustomsBroker','tranCustomsBrokerName','tranCustomsContact','tranCustomsTel','tranCustomsAddress',
	'tranContainerCompany','tranContainerCompanyName','tranContainerInfo','tranVessel','tranVoyage','tranSoNo','tranPol',
	'tranCyDraw',{name:'tranDrawDate',type:'date',dateFormat:DATEF},'tranCyBack',
...
FCustomsDeclaration= Ext.data.Record.create(['id',
	...
	'cudeManu','cudeMarks','cudeAttachment','cudeTaxLevy','cudeDeclarent','cudeCreator','cudeCompany',
	'cudeCompanyAddress','cudeCompanyZip','cudeCompanyTel',{name:'cudeCreateDate',type:'date',dateFormat:DATEF},
	...
	'cudeDocNum','cudeDocColor','cudeRefundDocNum','cudeType',
	...
	'cudeStatus','cudeDocStatus','cudeDocReleaseBy',{name:'cudeDocReleaseTime',type:'date',dateFormat:'Y-m-d H:i:s'},'cudeDocReceiver',
	'userId','grouId','createBy','modifyBy',{name:'createTime',type:'date',dateFormat:'Y-m-d H:i:s'},{name:'modifyTime',type:'date',dateFormat:'Y-m-d H:i:s'},
	'compCode','version','rowAction','attr1','attr2','attr3','attr4','attr5','attr6','attr7','attr8','attr9','attr10']);
FCustomsEntry= Ext.data.Record.create(['id',
	...
	'cuenCargoUnit','cuenCountry','cuenUnitPrice','cuenTotalPrice','currCode','cuenLevyType','cuenRemarks','cuenVersion',
	'userId','grouId','createBy','modifyBy',{name:'createTime',type:'date',dateFormat:'Y-m-d H:i:s'},{name:'modifyTime',type:'date',dateFormat:'Y-m-d H:i:s'},
	'compCode','version','rowAction']);
...
SExpense = Ext.data.Record.create(['id',
	...
	'consShipType','consCustId','consCustName','chclId','charId','charName','charNameEn','unitId','unitName','currCode','custId','custName','custSname',
	'expeType','pateId','pateCode',{name:'expeDate',type:'date',dateFormat:DATEF},{name:'consSailDate',type:'date',dateFormat:DATEF},
	{name:'expeUnitPrice',type:'float'},{name:'expeInnerPrice',type:'float'},{name:'expeNum',type:'float'},{name:'expeNum2',type:'float'},	
	...
	{name:'expeExRate',type:'float'},'expeBillNo','expeBillStatus','expeInvoiceNo','expeTaxInvoiceNo',{name:'expeInvoiceDate',type:'date',dateFormat:DATEF},
	{name:'expeInvoiceAmount',type:'float'},'expeInvoiceStatus',{name:'expeWriteOffDate',type:'date',dateFormat:DATEF},
	...
	'expeUpdateBy','expeUpdateTime','expeInvoiceBy','expeWriteOffBy','expeAllocationFlag','expeAllocatedFlag','expeIdM','consIdM','consNoM',
	'userId','grouId','createBy','modifyBy',{name:'createTime',type:'date',dateFormat:'Y-m-d H:i:s'},{name:'modifyTime',type:'date',dateFormat:'Y-m-d H:i:s'},
