...
Ext.form.MultiSelectComboBox = Ext.extend(Ext.form.ComboBox,   
{  
    checkField: 'checked',  
    multi: true,  
    separator: ',',  
    ...
    {  
        ...
        Ext.form.MultiSelectComboBox.superclass.initComponent.apply(this, arguments);  
    ...
    initEvents: function ()   
    {  
        Ext.form.MultiSelectComboBox.superclass.initEvents.apply(this, arguments);  
...
Ext.reg('multiSelectCombo', Ext.form.MultiSelectComboBox);   