FConsign = Ext.data.Record.create(['id','wconId',
	...
	'packId','packName','coclId','coclName','caclId','caclName','trtyId','trtyName','trteId',
	...
	'consStatusInvoR','consStatusInvoP',
	{name:'consInvoRDate',type:'date',dateFormat:DATEF},
	{name:'consInvoPDate',type:'date',dateFormat:DATEF},
	'consExternalFlag','consCudeType','consCustomsType',
	...
	{name:'cargDangerReportFlag',type:'boolean',convert:function(v){return v==1;}},
	{name:'cargDangerReportDate',type:'date',dateFormat:DATEF},
	{name:'cargReportFlag',type:'boolean',convert:function(v){return v==1;}},
	{name:'cargReportDate',type:'date',dateFormat:DATEF},
	'sewaName','settlementObjectId','settlementObjectName','cudeBizType','cudeTitle',
