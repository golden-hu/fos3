...
Fos.BookTab = function(p) {
    ...
    var f1={fieldLabel:p.get('consBizType')==BT_B?C_CHARTER:C_BOOKER,itemCls:'required',
    		tabIndex:1,name:'custName',value:p.get('custName'),store:getCS(),enableKeyEvents:true,
