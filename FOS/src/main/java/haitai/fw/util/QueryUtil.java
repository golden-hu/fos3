...
public class QueryUtil {
	...
	public static FosQuery compCodeCondition() {
		FosQuery compCode = new FosQuery(ConstUtil.CompCode,
				ConstUtil.SQL_OP_EQUAL, SessionManager
						.getStringAttr(SessionKeyType.COMPCODE));
		return compCode;
	}

	public static FosQuery removedCondition() {
		FosQuery removed = new FosQuery(ConstUtil.Removed,
				ConstUtil.SQL_OP_EQUAL, ConstUtil.FalseStr);
		return removed;
	}
