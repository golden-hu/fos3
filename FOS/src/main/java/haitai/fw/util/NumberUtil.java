...
public class NumberUtil {
	...
	private static final FosLogger logger = new FosLogger(NumberUtil.class);
	...
	public static Integer frontId2DbId(Map<Integer, Integer> idMap,
			Integer oldId) {
	...
	public static String num2EnWords(Number n) {
		if (n == null)
			return "";
		String[] digits = { null, "ONE ", "TWO ", "THREE ", "FOUR ", "FIVE ",
		...
		return store[9] + a1 + store[8] + store[7] + a2 + store[6] + a3
