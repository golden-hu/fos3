...
import haitai.fos.general.entity.table.*;
...
public class GeneralController<T> {
	...
	public List<GVoyage> getVoyageByVessel(Map<String, Object> queryMap) {
		IGeneralService<GVoyage> service = SpringContextHolder.getBean("GVoyageService");
		return service.query(queryMap);
	}

	@Transactional(readOnly = true)
	public List<GPort> getPortByCountry(Map<String, Object> queryMap) {
		IGeneralService<GPort> service = SpringContextHolder.getBean("GPortService");
		return service.query(queryMap);
	}

	@Transactional(readOnly = true)
	public List<GVessel> complexQueryVessel(List<FosQuery> conditions, Map<String, Object> queryMap) {
		IGeneralService<GVessel> service = SpringContextHolder.getBean("GVesselService");
		return service.complexQuery(conditions, queryMap);
	}

	@Transactional(readOnly = true)
	public List<GPort> complexQueryPort(List<FosQuery> conditions, Map<String, Object> queryMap) {
		IGeneralService<GPort> service = SpringContextHolder.getBean("GPortService");
		return service.complexQuery(conditions, queryMap);
	}
	...
	public List<GUnit> queryUnitPlusContType(Map<String, Object> queryMap) {
		...
		IGContainerTypeDAO containerTypeDao = SpringContextHolder.getBean("GContainerTypeDAO");
