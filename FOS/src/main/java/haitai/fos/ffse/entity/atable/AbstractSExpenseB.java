...
@MappedSuperclass
public abstract class AbstractSExpenseB extends BaseDomain {

	private static final long serialVersionUID = -443160307347086502L;
	...
	@Column(name = "EXPB_ID", unique = true, nullable = false)
	public Integer getExpbId() {
		return this.expbId;
	}

	public void setExpbId(Integer expbId) {
		this.expbId = expbId;
	}
