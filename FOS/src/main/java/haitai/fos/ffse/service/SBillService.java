...
public class SBillService {
	private ISBillDAO dao = null;
	private ISBillItemDAO itemDao = null;
	...
	@Transactional(readOnly = true)
	public List<SBill> complexQuery(List<FosQuery> conditions,
			Map<String, Object> queryMap) {
		return dao.complexQuery(conditions, queryMap);
	}	
	
	public ISBillDAO getDao() {
		return dao;
	}

	@Autowired
	public void setDao(ISBillDAO dao) {
		this.dao = dao;
	}

	public ISBillItemDAO getItemDao() {
		return itemDao;
	}

	@Autowired
	public void setItemDao(ISBillItemDAO itemDao) {
