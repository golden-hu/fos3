...
public class SPrService {
	private ISPrDAO dao = null;
	private ISPrItemDAO itemDao = null;
	...
	public void updateStatus(Map<String, Object> queryMap) {
		...
		dao.update(entity);
		if(ConstUtil.PR_STATUS_CANCELLED == prStatus){
			//找到prItem
	...
	@Transactional(readOnly = true)
	public List<SPr> complexQuery(List<FosQuery> conditions,
			Map<String, Object> queryMap) {
		return dao.complexQuery(conditions, queryMap);
	}
	
	public ISPrDAO getDao() {
		return dao;
	}

	@Autowired
	public void setDao(ISPrDAO dao) {
		this.dao = dao;
	}

	public ISPrItemDAO getItemDao() {
		return itemDao;
	}

	@Autowired
	public void setItemDao(ISPrItemDAO itemDao) {
