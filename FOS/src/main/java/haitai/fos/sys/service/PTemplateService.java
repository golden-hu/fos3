...
import haitai.fw.util.ClassMapUtil;
import haitai.fw.util.ConfigUtil;
import haitai.fw.util.ConstUtil;
import haitai.fw.util.FileUtil;
import haitai.fw.util.MappingConverterUtil;
...
public class PTemplateService {
	...
	private String executeConverter(PTemplateMap ptm, String newValue) {
		MappingConverterUtil converter = SpringContextUtil
				.getBean("MappingConverterUtil");
