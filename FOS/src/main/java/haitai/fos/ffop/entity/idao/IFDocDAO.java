...
public interface IFDocDAO {
	...
	public abstract List<FDoc> complexQuery(final List<FosQuery> conditions,
			final Map<String, Object> propertyMap);

	public abstract List<FDoc> complexQueryNeedRelease(
			final List<FosQuery> conditions,
			final Map<String, Object> propertyMap);

	public abstract List<FDoc> complexQueryNeedAlert(
			final List<FosQuery> conditions,
			final Map<String, Object> propertyMap);
