...
@XmlRootElement(name = "ValidateAccess", namespace = "http://tempuri.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ValidateAccess", namespace = "http://tempuri.org/", propOrder = {"accountID", "JSONKeyValuePair"})
