...
public class ProductAPIServiceLocator extends org.apache.axis.client.Service implements sg.com.ccn.org.tempuri.ProductAPIService {
    ...
    public sg.com.ccn.org.tempuri.IProductAPIService getBasicHttpBinding_IProductAPIService() throws javax.xml.rpc.ServiceException {
    ...
    public sg.com.ccn.org.tempuri.IProductAPIService getBasicHttpBinding_IProductAPIService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	sg.com.ccn.org.tempuri.BasicHttpBinding_IProductAPIServiceStub _stub = new sg.com.ccn.org.tempuri.BasicHttpBinding_IProductAPIServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (sg.com.ccn.org.tempuri.IProductAPIService.class.isAssignableFrom(serviceEndpointInterface)) {
            	sg.com.ccn.org.tempuri.BasicHttpBinding_IProductAPIServiceStub _stub = new sg.com.ccn.org.tempuri.BasicHttpBinding_IProductAPIServiceStub(new java.net.URL(BasicHttpBinding_IProductAPIService_address), this);
                _stub.setPortName(getBasicHttpBinding_IProductAPIServiceWSDDServiceName());
                return _stub;
            }
        }
