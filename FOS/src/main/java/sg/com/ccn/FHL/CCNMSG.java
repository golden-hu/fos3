...
public class CCNMSG  implements java.io.Serializable {
    private sg.com.ccn.FHL.Envelope msgEnvelope;

    private sg.com.ccn.FHL.MsgBody msgBody;

    public CCNMSG() {
    }

    public CCNMSG(
           sg.com.ccn.FHL.Envelope msgEnvelope,
           sg.com.ccn.FHL.MsgBody msgBody) {
     ...
     * @return msgEnvelope
     */
    public sg.com.ccn.FHL.Envelope getMsgEnvelope() {
        return msgEnvelope;
    }
     ...
     * @param msgEnvelope
     */
    public void setMsgEnvelope(sg.com.ccn.FHL.Envelope msgEnvelope) {
        this.msgEnvelope = msgEnvelope;
    }
     ...
     * @return msgBody
     */
    public sg.com.ccn.FHL.MsgBody getMsgBody() {
        return msgBody;
    }
     ...
     * @param msgBody
     */
    public void setMsgBody(sg.com.ccn.FHL.MsgBody msgBody) {
        this.msgBody = msgBody;
    }
