...
public class CCChargeDestinationCurrency  implements java.io.Serializable {
    private sg.com.ccn.FWB.DestinationCurrency destinationCurrency;

    private sg.com.ccn.FWB.CurrencyConversionRate currencyConversionRate;

    private sg.com.ccn.FWB.ChargeDestinationCurrency chargeDestinationCurrency;

    private sg.com.ccn.FWB.ChargeDestination chargeDestination;

    private sg.com.ccn.FWB.TotalCollectCharge totalCollectCharge;

    public CCChargeDestinationCurrency() {
    }

    public CCChargeDestinationCurrency(
           sg.com.ccn.FWB.DestinationCurrency destinationCurrency,
           sg.com.ccn.FWB.CurrencyConversionRate currencyConversionRate,
           sg.com.ccn.FWB.ChargeDestinationCurrency chargeDestinationCurrency,
           sg.com.ccn.FWB.ChargeDestination chargeDestination,
           sg.com.ccn.FWB.TotalCollectCharge totalCollectCharge) {
     ...
     */
    public sg.com.ccn.FWB.DestinationCurrency getDestinationCurrency() {
        return destinationCurrency;
    }
     ...
     */
    public void setDestinationCurrency(sg.com.ccn.FWB.DestinationCurrency destinationCurrency) {
        this.destinationCurrency = destinationCurrency;
    }
     ...
     */
    public sg.com.ccn.FWB.CurrencyConversionRate getCurrencyConversionRate() {
        return currencyConversionRate;
    }
     ...
     */
    public void setCurrencyConversionRate(sg.com.ccn.FWB.CurrencyConversionRate currencyConversionRate) {
        this.currencyConversionRate = currencyConversionRate;
    }
     ...
     */
    public sg.com.ccn.FWB.ChargeDestinationCurrency getChargeDestinationCurrency() {
        return chargeDestinationCurrency;
    }
     ...
     */
    public void setChargeDestinationCurrency(sg.com.ccn.FWB.ChargeDestinationCurrency chargeDestinationCurrency) {
        this.chargeDestinationCurrency = chargeDestinationCurrency;
    }
     ...
     */
    public sg.com.ccn.FWB.ChargeDestination getChargeDestination() {
        return chargeDestination;
    }
     ...
     */
    public void setChargeDestination(sg.com.ccn.FWB.ChargeDestination chargeDestination) {
        this.chargeDestination = chargeDestination;
    }
     ...
     */
    public sg.com.ccn.FWB.TotalCollectCharge getTotalCollectCharge() {
        return totalCollectCharge;
    }
     ...
     */
    public void setTotalCollectCharge(sg.com.ccn.FWB.TotalCollectCharge totalCollectCharge) {
        this.totalCollectCharge = totalCollectCharge;
    }
