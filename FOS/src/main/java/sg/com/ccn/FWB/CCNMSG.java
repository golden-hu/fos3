...
public class CCNMSG  implements java.io.Serializable {
    private sg.com.ccn.FWB.Envelope msgEnvelope;

    private sg.com.ccn.FWB.MsgBody msgBody;

    public CCNMSG() {
    }

    public CCNMSG(
           sg.com.ccn.FWB.Envelope msgEnvelope,
           sg.com.ccn.FWB.MsgBody msgBody) {
     ...
     * @return msgEnvelope
     */
    public sg.com.ccn.FWB.Envelope getMsgEnvelope() {
        return msgEnvelope;
    }
     ...
     * @param msgEnvelope
     */
    public void setMsgEnvelope(sg.com.ccn.FWB.Envelope msgEnvelope) {
        this.msgEnvelope = msgEnvelope;
    }
     ...
     * @return msgBody
     */
    public sg.com.ccn.FWB.MsgBody getMsgBody() {
        return msgBody;
    }
     ...
     * @param msgBody
     */
    public void setMsgBody(sg.com.ccn.FWB.MsgBody msgBody) {
        this.msgBody = msgBody;
    }
