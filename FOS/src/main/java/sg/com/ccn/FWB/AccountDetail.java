...
public class AccountDetail  implements java.io.Serializable {
    ...
    /**
     * Gets the accountNumber value for this AccountDetail.
     * 
    ...
    /**
     * Sets the accountNumber value for this AccountDetail.
     * 
     * @param accountNumber
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ccn.com.sg/CCNMSGWS", "AccountDetail"));
