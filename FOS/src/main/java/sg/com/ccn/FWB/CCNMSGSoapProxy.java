...
public class CCNMSGSoapProxy implements sg.com.ccn.FWB.CCNMSGSoap {
  private String _endpoint = null;
  private sg.com.ccn.FWB.CCNMSGSoap cCNMSGSoap = null;
  ...
  private void _initCCNMSGSoapProxy() {
    try {
      cCNMSGSoap = (new sg.com.ccn.FWB.CCNMSGServiceLocator()).getCCNMSG();
      if (cCNMSGSoap != null) {
        if (_endpoint != null)
  ...
  public sg.com.ccn.FWB.CCNMSGSoap getCCNMSGSoap() {
    if (cCNMSGSoap == null)
      _initCCNMSGSoapProxy();
    return cCNMSGSoap;
  }
  
  public void airWaybillData(sg.com.ccn.FWB.CCNMSG parameter) throws java.rmi.RemoteException{
    if (cCNMSGSoap == null)
      _initCCNMSGSoapProxy();
