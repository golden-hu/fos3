...
public class CarrierExection  implements java.io.Serializable {
    private sg.com.ccn.FWB.AWBIssueDetail AWBIssueDetail;

    private sg.com.ccn.FWB.Authorisation authorisation;

    public CarrierExection() {
    }

    public CarrierExection(
           sg.com.ccn.FWB.AWBIssueDetail AWBIssueDetail,
           sg.com.ccn.FWB.Authorisation authorisation) {
     ...
     */
    public sg.com.ccn.FWB.AWBIssueDetail getAWBIssueDetail() {
        return AWBIssueDetail;
    }
     ...
     */
    public void setAWBIssueDetail(sg.com.ccn.FWB.AWBIssueDetail AWBIssueDetail) {
        this.AWBIssueDetail = AWBIssueDetail;
    }
     ...
     */
    public sg.com.ccn.FWB.Authorisation getAuthorisation() {
        return authorisation;
    }
     ...
     * @param authorisation
     */
    public void setAuthorisation(sg.com.ccn.FWB.Authorisation authorisation) {
        this.authorisation = authorisation;
    }
