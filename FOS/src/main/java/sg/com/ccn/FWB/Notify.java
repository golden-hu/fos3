...
public class Notify  implements java.io.Serializable {
    private sg.com.ccn.FWB.Name notifyName;

    private sg.com.ccn.FWB.StreetAddress notifyStreetAddress;

    private sg.com.ccn.FWB.Location notifyLocation;

    private sg.com.ccn.FWB.CodedLocation notifyCodedLocation;

    private sg.com.ccn.FWB.ContactDetail[] notifyContactDetail;

    public Notify() {
    }

    public Notify(
           sg.com.ccn.FWB.Name notifyName,
           sg.com.ccn.FWB.StreetAddress notifyStreetAddress,
           sg.com.ccn.FWB.Location notifyLocation,
           sg.com.ccn.FWB.CodedLocation notifyCodedLocation,
           sg.com.ccn.FWB.ContactDetail[] notifyContactDetail) {
     ...
     * @return notifyName
     */
    public sg.com.ccn.FWB.Name getNotifyName() {
        return notifyName;
    }
     ...
     * @param notifyName
     */
    public void setNotifyName(sg.com.ccn.FWB.Name notifyName) {
        this.notifyName = notifyName;
    }
     ...
     */
    public sg.com.ccn.FWB.StreetAddress getNotifyStreetAddress() {
        return notifyStreetAddress;
    }
     ...
     */
    public void setNotifyStreetAddress(sg.com.ccn.FWB.StreetAddress notifyStreetAddress) {
        this.notifyStreetAddress = notifyStreetAddress;
    }
     ...
     */
    public sg.com.ccn.FWB.Location getNotifyLocation() {
        return notifyLocation;
    }
     ...
     */
    public void setNotifyLocation(sg.com.ccn.FWB.Location notifyLocation) {
        this.notifyLocation = notifyLocation;
    }
     ...
     */
    public sg.com.ccn.FWB.CodedLocation getNotifyCodedLocation() {
        return notifyCodedLocation;
    }
     ...
     */
    public void setNotifyCodedLocation(sg.com.ccn.FWB.CodedLocation notifyCodedLocation) {
        this.notifyCodedLocation = notifyCodedLocation;
    }
     ...
     */
    public sg.com.ccn.FWB.ContactDetail[] getNotifyContactDetail() {
        return notifyContactDetail;
    }
     ...
     */
    public void setNotifyContactDetail(sg.com.ccn.FWB.ContactDetail[] notifyContactDetail) {
        this.notifyContactDetail = notifyContactDetail;
    }

    public sg.com.ccn.FWB.ContactDetail getNotifyContactDetail(int i) {
        return this.notifyContactDetail[i];
    }

    public void setNotifyContactDetail(int i, sg.com.ccn.FWB.ContactDetail _value) {
