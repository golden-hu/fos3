...
public class SenderReference  implements java.io.Serializable {
    private sg.com.ccn.FWB.SenderOfficeMessageAddress senderOfficeMessageAddress;

    private sg.com.ccn.FWB.SenderOfficeFileReference senderOfficeFileReference;

    private sg.com.ccn.FWB.SenderParticipantIdentification senderParticipantIdentification;

    public SenderReference() {
    }

    public SenderReference(
           sg.com.ccn.FWB.SenderOfficeMessageAddress senderOfficeMessageAddress,
           sg.com.ccn.FWB.SenderOfficeFileReference senderOfficeFileReference,
           sg.com.ccn.FWB.SenderParticipantIdentification senderParticipantIdentification) {
     ...
     */
    public sg.com.ccn.FWB.SenderOfficeMessageAddress getSenderOfficeMessageAddress() {
        return senderOfficeMessageAddress;
    }
     ...
     */
    public void setSenderOfficeMessageAddress(sg.com.ccn.FWB.SenderOfficeMessageAddress senderOfficeMessageAddress) {
        this.senderOfficeMessageAddress = senderOfficeMessageAddress;
    }
     ...
     */
    public sg.com.ccn.FWB.SenderOfficeFileReference getSenderOfficeFileReference() {
        return senderOfficeFileReference;
    }
     ...
     */
    public void setSenderOfficeFileReference(sg.com.ccn.FWB.SenderOfficeFileReference senderOfficeFileReference) {
        this.senderOfficeFileReference = senderOfficeFileReference;
    }
     ...
     */
    public sg.com.ccn.FWB.SenderParticipantIdentification getSenderParticipantIdentification() {
        return senderParticipantIdentification;
    }
     ...
     */
    public void setSenderParticipantIdentification(sg.com.ccn.FWB.SenderParticipantIdentification senderParticipantIdentification) {
        this.senderParticipantIdentification = senderParticipantIdentification;
    }
