...
public class CommissionInformation  implements java.io.Serializable {
    private sg.com.ccn.FWB.NoCommissionIndication noCommissionIndication;

    private sg.com.ccn.FWB.CommissionAmount commissionAmount;

    private sg.com.ccn.FWB.CommissionPercentage commissionPercentage;

    public CommissionInformation() {
    }

    public CommissionInformation(
           sg.com.ccn.FWB.NoCommissionIndication noCommissionIndication,
           sg.com.ccn.FWB.CommissionAmount commissionAmount,
           sg.com.ccn.FWB.CommissionPercentage commissionPercentage) {
     ...
     */
    public sg.com.ccn.FWB.NoCommissionIndication getNoCommissionIndication() {
        return noCommissionIndication;
    }
     ...
     */
    public void setNoCommissionIndication(sg.com.ccn.FWB.NoCommissionIndication noCommissionIndication) {
        this.noCommissionIndication = noCommissionIndication;
    }
     ...
     */
    public sg.com.ccn.FWB.CommissionAmount getCommissionAmount() {
        return commissionAmount;
    }
     ...
     */
    public void setCommissionAmount(sg.com.ccn.FWB.CommissionAmount commissionAmount) {
        this.commissionAmount = commissionAmount;
    }
     ...
     */
    public sg.com.ccn.FWB.CommissionPercentage getCommissionPercentage() {
        return commissionPercentage;
    }
     ...
     */
    public void setCommissionPercentage(sg.com.ccn.FWB.CommissionPercentage commissionPercentage) {
        this.commissionPercentage = commissionPercentage;
    }
