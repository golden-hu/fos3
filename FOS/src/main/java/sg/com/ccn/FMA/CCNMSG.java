...
public class CCNMSG  implements java.io.Serializable {
    private sg.com.ccn.FMA.Envelope msgEnvelope;

    private sg.com.ccn.FMA.MsgBody msgBody;

    public CCNMSG() {
    }

    public CCNMSG(
           sg.com.ccn.FMA.Envelope msgEnvelope,
           sg.com.ccn.FMA.MsgBody msgBody) {
     ...
     * @return msgEnvelope
     */
    public sg.com.ccn.FMA.Envelope getMsgEnvelope() {
        return msgEnvelope;
    }
     ...
     * @param msgEnvelope
     */
    public void setMsgEnvelope(sg.com.ccn.FMA.Envelope msgEnvelope) {
        this.msgEnvelope = msgEnvelope;
    }
     ...
     * @return msgBody
     */
    public sg.com.ccn.FMA.MsgBody getMsgBody() {
        return msgBody;
    }
     ...
     * @param msgBody
     */
    public void setMsgBody(sg.com.ccn.FMA.MsgBody msgBody) {
        this.msgBody = msgBody;
    }
