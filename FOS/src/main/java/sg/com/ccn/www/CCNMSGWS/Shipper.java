...
public class Shipper  implements java.io.Serializable {
    private sg.com.ccn.www.CCNMSGWS.AccountDetail shipperAccountDetail;

    private sg.com.ccn.www.CCNMSGWS.Name shipperName;

    private sg.com.ccn.www.CCNMSGWS.StreetAddress shipperStreetAddress;

    private sg.com.ccn.www.CCNMSGWS.Location shipperLocation;

    private sg.com.ccn.www.CCNMSGWS.CodedLocation shipperCodedLocation;

    private sg.com.ccn.www.CCNMSGWS.ContactDetail[] shipperContactDetail;

    public Shipper() {
    }

    public Shipper(
           sg.com.ccn.www.CCNMSGWS.AccountDetail shipperAccountDetail,
           sg.com.ccn.www.CCNMSGWS.Name shipperName,
           sg.com.ccn.www.CCNMSGWS.StreetAddress shipperStreetAddress,
           sg.com.ccn.www.CCNMSGWS.Location shipperLocation,
           sg.com.ccn.www.CCNMSGWS.CodedLocation shipperCodedLocation,
           sg.com.ccn.www.CCNMSGWS.ContactDetail[] shipperContactDetail) {
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.AccountDetail getShipperAccountDetail() {
        return shipperAccountDetail;
    }
     ...
     */
    public void setShipperAccountDetail(sg.com.ccn.www.CCNMSGWS.AccountDetail shipperAccountDetail) {
        this.shipperAccountDetail = shipperAccountDetail;
    }
     ...
     * @return shipperName
     */
    public sg.com.ccn.www.CCNMSGWS.Name getShipperName() {
        return shipperName;
    }
     ...
     * @param shipperName
     */
    public void setShipperName(sg.com.ccn.www.CCNMSGWS.Name shipperName) {
        this.shipperName = shipperName;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.StreetAddress getShipperStreetAddress() {
        return shipperStreetAddress;
    }
     ...
     */
    public void setShipperStreetAddress(sg.com.ccn.www.CCNMSGWS.StreetAddress shipperStreetAddress) {
        this.shipperStreetAddress = shipperStreetAddress;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.Location getShipperLocation() {
        return shipperLocation;
    }
     ...
     */
    public void setShipperLocation(sg.com.ccn.www.CCNMSGWS.Location shipperLocation) {
        this.shipperLocation = shipperLocation;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.CodedLocation getShipperCodedLocation() {
        return shipperCodedLocation;
    }
     ...
     */
    public void setShipperCodedLocation(sg.com.ccn.www.CCNMSGWS.CodedLocation shipperCodedLocation) {
        this.shipperCodedLocation = shipperCodedLocation;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.ContactDetail[] getShipperContactDetail() {
        return shipperContactDetail;
    }
     ...
     */
    public void setShipperContactDetail(sg.com.ccn.www.CCNMSGWS.ContactDetail[] shipperContactDetail) {
        this.shipperContactDetail = shipperContactDetail;
    }

    public sg.com.ccn.www.CCNMSGWS.ContactDetail getShipperContactDetail(int i) {
        return this.shipperContactDetail[i];
    }

    public void setShipperContactDetail(int i, sg.com.ccn.www.CCNMSGWS.ContactDetail _value) {
