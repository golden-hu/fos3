...
public class Routing  implements java.io.Serializable {
    private sg.com.ccn.www.CCNMSGWS.FirstDestination firstDestination;

    private sg.com.ccn.www.CCNMSGWS.OnwardDestination[] onwardDestination;

    public Routing() {
    }

    public Routing(
           sg.com.ccn.www.CCNMSGWS.FirstDestination firstDestination,
           sg.com.ccn.www.CCNMSGWS.OnwardDestination[] onwardDestination) {
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.FirstDestination getFirstDestination() {
        return firstDestination;
    }
     ...
     */
    public void setFirstDestination(sg.com.ccn.www.CCNMSGWS.FirstDestination firstDestination) {
        this.firstDestination = firstDestination;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.OnwardDestination[] getOnwardDestination() {
        return onwardDestination;
    }
     ...
     */
    public void setOnwardDestination(sg.com.ccn.www.CCNMSGWS.OnwardDestination[] onwardDestination) {
        this.onwardDestination = onwardDestination;
    }

    public sg.com.ccn.www.CCNMSGWS.OnwardDestination getOnwardDestination(int i) {
        return this.onwardDestination[i];
    }

    public void setOnwardDestination(int i, sg.com.ccn.www.CCNMSGWS.OnwardDestination _value) {
