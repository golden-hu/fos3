...
public class ConsignmentDetail  implements java.io.Serializable {
    private sg.com.ccn.www.CCNMSGWS.AWBIdentification AWBIdentification;

    private sg.com.ccn.www.CCNMSGWS.AWBOriginAndDestination AWBOriginAndDestination;

    private sg.com.ccn.www.CCNMSGWS.QuantityDetail quantityDetail;

    private sg.com.ccn.www.CCNMSGWS.Volume volumeDetail;

    private sg.com.ccn.www.CCNMSGWS.DensityGroup densityGroup;

    public ConsignmentDetail() {
    }

    public ConsignmentDetail(
           sg.com.ccn.www.CCNMSGWS.AWBIdentification AWBIdentification,
           sg.com.ccn.www.CCNMSGWS.AWBOriginAndDestination AWBOriginAndDestination,
           sg.com.ccn.www.CCNMSGWS.QuantityDetail quantityDetail,
           sg.com.ccn.www.CCNMSGWS.Volume volumeDetail,
           sg.com.ccn.www.CCNMSGWS.DensityGroup densityGroup) {
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.AWBIdentification getAWBIdentification() {
        return AWBIdentification;
    }
     ...
     */
    public void setAWBIdentification(sg.com.ccn.www.CCNMSGWS.AWBIdentification AWBIdentification) {
        this.AWBIdentification = AWBIdentification;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.AWBOriginAndDestination getAWBOriginAndDestination() {
        return AWBOriginAndDestination;
    }
     ...
     */
    public void setAWBOriginAndDestination(sg.com.ccn.www.CCNMSGWS.AWBOriginAndDestination AWBOriginAndDestination) {
        this.AWBOriginAndDestination = AWBOriginAndDestination;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.QuantityDetail getQuantityDetail() {
        return quantityDetail;
    }
     ...
     */
    public void setQuantityDetail(sg.com.ccn.www.CCNMSGWS.QuantityDetail quantityDetail) {
        this.quantityDetail = quantityDetail;
    }
     ...
     * @return volumeDetail
     */
    public sg.com.ccn.www.CCNMSGWS.Volume getVolumeDetail() {
        return volumeDetail;
    }
     ...
     * @param volumeDetail
     */
    public void setVolumeDetail(sg.com.ccn.www.CCNMSGWS.Volume volumeDetail) {
        this.volumeDetail = volumeDetail;
    }
     ...
     * @return densityGroup
     */
    public sg.com.ccn.www.CCNMSGWS.DensityGroup getDensityGroup() {
        return densityGroup;
    }
     ...
     * @param densityGroup
     */
    public void setDensityGroup(sg.com.ccn.www.CCNMSGWS.DensityGroup densityGroup) {
        this.densityGroup = densityGroup;
    }
