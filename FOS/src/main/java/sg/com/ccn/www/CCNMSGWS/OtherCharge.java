...
public class OtherCharge  implements java.io.Serializable {
    private sg.com.ccn.www.CCNMSGWS.ChargeLine chargeLine;

    public OtherCharge() {
    }

    public OtherCharge(
           sg.com.ccn.www.CCNMSGWS.ChargeLine chargeLine) {
     ...
     * @return chargeLine
     */
    public sg.com.ccn.www.CCNMSGWS.ChargeLine getChargeLine() {
        return chargeLine;
    }
     ...
     * @param chargeLine
     */
    public void setChargeLine(sg.com.ccn.www.CCNMSGWS.ChargeLine chargeLine) {
        this.chargeLine = chargeLine;
    }
