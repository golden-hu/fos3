...
public class ChargeLine  implements java.io.Serializable {
    ...
    private sg.com.ccn.www.CCNMSGWS.OtherChargeItem[] otherChargeItem;
    ...
    public ChargeLine(
           ...
           sg.com.ccn.www.CCNMSGWS.OtherChargeItem[] otherChargeItem) {
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.OtherChargeItem[] getOtherChargeItem() {
        return otherChargeItem;
    }
     ...
     */
    public void setOtherChargeItem(sg.com.ccn.www.CCNMSGWS.OtherChargeItem[] otherChargeItem) {
        this.otherChargeItem = otherChargeItem;
    }

    public sg.com.ccn.www.CCNMSGWS.OtherChargeItem getOtherChargeItem(int i) {
        return this.otherChargeItem[i];
    }

    public void setOtherChargeItem(int i, sg.com.ccn.www.CCNMSGWS.OtherChargeItem _value) {
