...
public class Consignee  implements java.io.Serializable {
    private sg.com.ccn.www.CCNMSGWS.AccountDetail consigneeAccountDetail;

    private sg.com.ccn.www.CCNMSGWS.Name consigneeName;

    private sg.com.ccn.www.CCNMSGWS.StreetAddress consigneeStreetAddress;

    private sg.com.ccn.www.CCNMSGWS.Location consigneeLocation;

    private sg.com.ccn.www.CCNMSGWS.CodedLocation consigneeCodedLocation;

    private sg.com.ccn.www.CCNMSGWS.ContactDetail[] consigneeContactDetail;

    public Consignee() {
    }

    public Consignee(
           sg.com.ccn.www.CCNMSGWS.AccountDetail consigneeAccountDetail,
           sg.com.ccn.www.CCNMSGWS.Name consigneeName,
           sg.com.ccn.www.CCNMSGWS.StreetAddress consigneeStreetAddress,
           sg.com.ccn.www.CCNMSGWS.Location consigneeLocation,
           sg.com.ccn.www.CCNMSGWS.CodedLocation consigneeCodedLocation,
           sg.com.ccn.www.CCNMSGWS.ContactDetail[] consigneeContactDetail) {
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.AccountDetail getConsigneeAccountDetail() {
        return consigneeAccountDetail;
    }
     ...
     */
    public void setConsigneeAccountDetail(sg.com.ccn.www.CCNMSGWS.AccountDetail consigneeAccountDetail) {
        this.consigneeAccountDetail = consigneeAccountDetail;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.Name getConsigneeName() {
        return consigneeName;
    }
     ...
     * @param consigneeName
     */
    public void setConsigneeName(sg.com.ccn.www.CCNMSGWS.Name consigneeName) {
        this.consigneeName = consigneeName;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.StreetAddress getConsigneeStreetAddress() {
        return consigneeStreetAddress;
    }
     ...
     */
    public void setConsigneeStreetAddress(sg.com.ccn.www.CCNMSGWS.StreetAddress consigneeStreetAddress) {
        this.consigneeStreetAddress = consigneeStreetAddress;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.Location getConsigneeLocation() {
        return consigneeLocation;
    }
     ...
     */
    public void setConsigneeLocation(sg.com.ccn.www.CCNMSGWS.Location consigneeLocation) {
        this.consigneeLocation = consigneeLocation;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.CodedLocation getConsigneeCodedLocation() {
        return consigneeCodedLocation;
    }
     ...
     */
    public void setConsigneeCodedLocation(sg.com.ccn.www.CCNMSGWS.CodedLocation consigneeCodedLocation) {
        this.consigneeCodedLocation = consigneeCodedLocation;
    }
     ...
     */
    public sg.com.ccn.www.CCNMSGWS.ContactDetail[] getConsigneeContactDetail() {
        return consigneeContactDetail;
    }
     ...
     */
    public void setConsigneeContactDetail(sg.com.ccn.www.CCNMSGWS.ContactDetail[] consigneeContactDetail) {
        this.consigneeContactDetail = consigneeContactDetail;
    }

    public sg.com.ccn.www.CCNMSGWS.ContactDetail getConsigneeContactDetail(int i) {
        return this.consigneeContactDetail[i];
    }

    public void setConsigneeContactDetail(int i, sg.com.ccn.www.CCNMSGWS.ContactDetail _value) {
