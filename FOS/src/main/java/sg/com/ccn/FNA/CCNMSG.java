...
public class CCNMSG  implements java.io.Serializable {
    private sg.com.ccn.FNA.Envelope msgEnvelope;

    private sg.com.ccn.FNA.MsgBody msgBody;

    public CCNMSG() {
    }

    public CCNMSG(
           sg.com.ccn.FNA.Envelope msgEnvelope,
           sg.com.ccn.FNA.MsgBody msgBody) {
     ...
     * @return msgEnvelope
     */
    public sg.com.ccn.FNA.Envelope getMsgEnvelope() {
        return msgEnvelope;
    }
     ...
     * @param msgEnvelope
     */
    public void setMsgEnvelope(sg.com.ccn.FNA.Envelope msgEnvelope) {
        this.msgEnvelope = msgEnvelope;
    }
     ...
     * @return msgBody
     */
    public sg.com.ccn.FNA.MsgBody getMsgBody() {
        return msgBody;
    }
     ...
     * @param msgBody
     */
    public void setMsgBody(sg.com.ccn.FNA.MsgBody msgBody) {
        this.msgBody = msgBody;
    }
