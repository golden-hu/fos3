...
public class CCNMSG  implements java.io.Serializable {
    private sg.com.ccn.FSU.Envelope msgEnvelope;

    private sg.com.ccn.FSU.MsgBody msgBody;

    public CCNMSG() {
    }

    public CCNMSG(
           sg.com.ccn.FSU.Envelope msgEnvelope,
           sg.com.ccn.FSU.MsgBody msgBody) {
     ...
     * @return msgEnvelope
     */
    public sg.com.ccn.FSU.Envelope getMsgEnvelope() {
        return msgEnvelope;
    }
     ...
     * @param msgEnvelope
     */
    public void setMsgEnvelope(sg.com.ccn.FSU.Envelope msgEnvelope) {
        this.msgEnvelope = msgEnvelope;
    }
     ...
     * @return msgBody
     */
    public sg.com.ccn.FSU.MsgBody getMsgBody() {
        return msgBody;
    }
     ...
     * @param msgBody
     */
    public void setMsgBody(sg.com.ccn.FSU.MsgBody msgBody) {
        this.msgBody = msgBody;
    }
